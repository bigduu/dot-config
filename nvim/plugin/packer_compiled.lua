...
_G.packer_plugins = {
  ...
  ["cmp-tabnine"] = {
    loaded = true,
    path = "/Users/bigduu/.local/share/nvim/site/pack/packer/start/cmp-tabnine",
  ...
  cmp_luasnip = {
    loaded = true,
    path = "/Users/bigduu/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
    url = "https://github.com/saadparwaiz1/cmp_luasnip"
  },
  ["copilot.vim"] = {
    loaded = true,
    path = "/Users/bigduu/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["fine-cmdline.nvim"] = {
    loaded = true,
    path = "/Users/bigduu/.local/share/nvim/site/pack/packer/start/fine-cmdline.nvim",
  ...
  ["lsp-format.nvim"] = {
    loaded = true,
    path = "/Users/bigduu/.local/share/nvim/site/pack/packer/start/lsp-format.nvim",
  ...
  ["nui.nvim"] = {
    loaded = true,
    path = "/Users/bigduu/.local/share/nvim/site/pack/packer/start/nui.nvim",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/Users/bigduu/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["vim-airline"] = {
    loaded = true,
    path = "/Users/bigduu/.local/share/nvim/site/pack/packer/start/vim-airline",
    url = "https://github.com/vim-airline/vim-airline"
  },
  ["vim-airline-themes"] = {
    loaded = true,
    path = "/Users/bigduu/.local/share/nvim/site/pack/packer/start/vim-airline-themes",
